<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a href="index.html">BirPenNJ</a>
    </div>
    <div class="sidebar-brand sidebar-brand-sm">
      <a href="index.html">PKGNJ</a>
    </div>
    <ul class="sidebar-menu">
      ...
      <li class="nav-item dropdown active">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="index-0.html">Kepala Sekolah</a></li>
          <li><a class="nav-link" href="index-0.html">Guru</a></li>
          <li class="active"><a class="nav-link" href="index.html">Siswa</a></li>
        </ul>
      </li>
